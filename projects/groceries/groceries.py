...
products = [{"id":1, "name": "Chocolate Sandwich Cookies", "department": "snacks", "aisle": "cookies cakes", "price": 3.50},
    ...
    {"id":20, "name": "Pomegranate Cranberry & Aloe Vera Enrich Drink", "department": "beverages", "aisle": "juice nectars", "price": 4.25}] #<-- Copy and paste the provided products list here (see above!)
...
for item in departments_alpha_order:
    print(" + " + item.title() + " (" + str(department_list.count(item)) + " products)")
